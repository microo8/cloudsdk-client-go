...
const (
	...
	//OcrClient.GetTaskStatusAsync(UUID) for the first of those tasks.
...
// Format of exporting recognized text.  Several formats may be provided at once
...
const (
	...
	//PDF/A-1b. The file is saved in PDF/A-1b-compliant format, with the entire image saved as a picture and recognized text put under it.
	ExportFormatPdfA ExportFormat = "pdfA"

	//XML. All coordinates are saved relative to the original image.
	//
	//Note: See https://www.ocrsdk.com/documentation/specifications/xml-scheme-recognized-document
	//Output XML Documentfor the description of tags. If you select this export format, barcodes
	...
	//
	//Note: See https://www.ocrsdk.com/documentation/specifications/xml-scheme-recognized-document
	//Output XML Document for the description of tags. If you select this export format, barcodes
	//are recognized on the image and saved to output XML no matter which profile is used for recognition.
...
const (
	...
	//
	//Note: This profile is not intended for converting documents into an editable format. It is designed for
...
//Types of text supported by ABBYY Cloud OCR SDK. Several types may be provided at once
//Note: See https://www.ocrsdk.com/documentation/specifications/text-types
...
//
//Note: See https://www.ocrsdk.com/documentation/specifications/field-marking
